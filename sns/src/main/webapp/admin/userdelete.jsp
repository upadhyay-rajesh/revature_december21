	...
	<div class="row-fluid">
		...
		<div class="span9" id="content">
			...
			<%
				...
				x.setUser_name(user_name);
				SnsServiceUserInterface service = new SnsServiceUserImpl();
				int c = service.delete(x);
				if (c != 0) {

					ServletContext sc = this.getServletContext();
					String path = sc.getRealPath("/");
					File f = new File(path + "/document/" + user_name);
					delete_dir dr = new delete_dir();
					boolean bl = dr.delete(f);
					if (bl) {
			%>
