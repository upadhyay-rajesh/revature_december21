...
<div class="container">
 ...
 %> &nbsp;&nbsp; <a href="personl_message.jsp"><i
	...
	<form name="form" method="get" action="../SnsUserController"	class="search-box">

		<input id="search" name="search" type="text" > 
		<input type=hidden name=method value="user_search_result">
	...
	<div style="width: 150px; float: right">
		<div class="btn-group"
			...
			<button type="button" data-toggle="dropdown"
				class="btn btn-default dropdown-toggle"><%=currentUser%>
