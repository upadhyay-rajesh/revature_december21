                ...
                <div class="row-fluid">
                    ...
                    <div class="block1" style="margin-left: 150px;margin-right: -90px">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Registration </div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <!-- BEGIN FORM-->
                               
                                <form action="../SnsUserController?method=user_registration" method="post" id="form_sample_1" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="user_name" data-required="1" class="DuplicateUserName span6 m-wrap"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="user_pass" type="password" id="password" class="required" class="span6 m-wrap"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Confirm Password<span class="required">*</span></label>
                                            <div class="controls">
                                                <input name="user_confirm_pass" type="password" class="span6 m-wrap" class="required"/>
                                            </div>
